    ...
    for tollgate_id in tollgate_list:
        ...
        def generate_train(volume_entry, volume_exit, entry_file_path=None, exit_file_path=None):
            ...
            for j in range(6):
                ...
                entry_df = entry_df.append(train_df)
            ...
            for j in range(6):
                ...
                exit_df = exit_df.append(train_df)
        ...
        def generate_test(volume_entry_test, volume_exit_test,
            ...
            for i in range(6):
                ...
                entry_df = entry_df.append(test_entry_df)
            ...
            for i in range(6):
                ...
                exit_df = exit_df.append(test_exit_df)
            return entry_df, exit_df

        record_entry_train, record_exit_train = divide_train_by_direction(volume_train)
        volume_entry_train, volume_exit_train = generate_train(record_entry_train, record_exit_train)
        volume_entry_train["tollgate_id"] = tollgate_id
        volume_entry_train["direction"] = "entry"
        volume_exit_train["tollgate_id"] = tollgate_id
        volume_exit_train["direction"] = "exit"
        train_df = train_df.append(volume_entry_train)
        train_df = train_df.append(volume_exit_train)

        record_entry_test, record_exit_test = divide_test_by_direction(volume_test)
        volume_entry_test, volume_exit_test = generate_test(record_entry_train, record_exit_test)
        volume_entry_test["tollgate_id"] = tollgate_id
        volume_entry_test["direction"] = "entry"
        volume_exit_test["tollgate_id"] = tollgate_id
        volume_exit_test["direction"] = "exit"
        test_df = test_df.append(volume_entry_test)
        test_df = test_df.append(volume_exit_test)

    train_df.to_csv("./train&test3_zjw/train.csv")
    test_df.to_csv("./train&test3_zjw/test.csv")
